...
So basically in simple terms the .git folder consists of all the files and directories which provides necessary materials to track changes. 
Without this folder we cannot 

# Command
```bash
git init 
``` 
[<<Back to Previous Page](./AddnCommit.md)  <div align="right">[Continue to Next Page >>](./GitPush.md) </div>
